...
<head>
  ...
  <title>Csorvási GAZDÁK ZRT</title>
  <meta content="" name="descriptison">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="fontend/assets/img/favicon.png" rel="icon">
  <link href="fontend/assets/img/apple-touch-icon.png" rel="apple-touch-icon">
  ...
  <link href="fontend/assets/css/style.css" rel="stylesheet">
