...
<html lang="en" dir="ltr">
  ...
  <link id="sleek-css" rel="stylesheet" href="{{ asset('backend/assets/css/sleek.css') }}" />
    ...
    <link type="texz/css" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.css" rel="stylesheet" />
  <!-- FAVICON -->
      ...
      <div class="page-wrapper">
            ...
            <nav class="navbar navbar-static-top navbar-expand-lg">
              ...
              <div class="search-form d-none d-lg-inline-block">
                <div class="input-group">
                  ...
                  <input type="text" name="query" id="search-input" class="form-control" placeholder="Keresés..."
              ...
              <div class="navbar-right ">
                <ul class="nav navbar-nav">
                  ...
                  <li class="github-link mr-3">
                    <a class="btn btn-outline-secondary btn-sm" href="https://github.com/BalazsFoldhazi" target="_blank">
                      <span class="d-none d-md-inline-block mr-2">My source code - GITHUB</span>
        ...
        <footer class="footer mt-auto">
            <div class="copyright bg-white">
              <p>
                &copy; <span id="copy-year">2021</span> Rapid Web-application development with Laravel framework NJE-GAMF
                <a
                  class="text-primary"
                  href="http://www.aground.hu/"
                  target="_blank"
                  >Balázs Földházi ROZFRQ</a
                >.
              </p>
            </div>
            <script>
